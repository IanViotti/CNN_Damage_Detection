...
def read_damage():
    ...
    df = pd.read_csv('damage_variables3.csv')
    df_arr = df.to_numpy()
    return df_arr
...
def run_model(dam_var, struct_prop, mat_prop): 
    ...
    os.system("\"C:\\Program Files\\ANSYS Inc\\v192\\ansys\\bin\\winx64\\MAPDL.exe\" -b -j output -dir C:\\Users\\Guilherme\\skin_damage -i C:\\Users\\Guilherme\\skin_damage\\APDL_Skin_Damage.txt -o C:\\Users\\Guilherme\\skin_damage\\Model_Output.out")
